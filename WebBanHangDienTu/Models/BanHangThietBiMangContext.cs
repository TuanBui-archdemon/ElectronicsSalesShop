...
{
    public partial class BanHangThietBiMangContext : DbContext
    {
        public BanHangThietBiMangContext()
        {
        }

        public BanHangThietBiMangContext(DbContextOptions<BanHangThietBiMangContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-MGN3IP8\\SQLEXPRESS;Database=BanHangThietBiMang;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QuangCao>(entity =>
            {
                ...
                entity.Property(e => e.ImageBg).HasMaxLength(200);

                entity.Property(e => e.ImageProduct).HasMaxLength(200);
            ...
            modelBuilder.Entity<TblTinTuc>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasConstraintName("FK_tblTinTucs_Accounts1");

                entity.HasOne(d => d.Cat)
                    .WithMany(p => p.TblTinTucs)
                    .HasForeignKey(d => d.CatId)
                    .HasConstraintName("FK_tblTinTucs_Categories1");
            });
