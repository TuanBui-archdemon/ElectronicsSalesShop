...
namespace WebBanHangDienTu.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(BanHangThietBiMangContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var banHangThietBiMangContext = _context.Accounts.Include(a => a.Role);
            return View(await banHangThietBiMangContext.ToListAsync());
        }
