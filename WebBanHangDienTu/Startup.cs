...
namespace WebBanHangDienTu
{
    public class Startup
    {
        ...
        {
            var stringConnectdb = Configuration.GetConnectionString("BanHangThietBiMang");
            services.AddDbContext<BanHangThietBiMangContext>(options => options.UseSqlServer(stringConnectdb));
